...
export const queryAuthenticationCertificateKey = () => ({
    method: 'get',
    url: 'vpn/v1/certificate/key/ec',
});

export const queryAuthenticationCertificate = ({ ClientPublicKey, DeviceName, Duration, Mode, Features }) => ({
    method: 'post',
    url: 'vpn/v1/certificate',
    data: { ClientPublicKey, DeviceName, Duration, Mode, Features },
});
