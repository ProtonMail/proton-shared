...
export const queryAuthenticationCertificateKey = (mode) => ({
    method: 'get',
    url: `vpn/v1/certificate/key/${mode || 'ec'}`,
});

export const queryAuthenticationCertificate = ({
    ClientPublicKey,
    ClientPublicKeyMode,
    DeviceName,
    Duration,
    ...
    data: { ClientPublicKey, ClientPublicKeyMode, DeviceName, Duration, Mode, Features },
});
