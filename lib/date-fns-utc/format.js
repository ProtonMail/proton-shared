 ...
 * What the format function from 'date-fns' does is for extracting from a date (think of it as a UNIX timestamp)
 * the hours, day, month, etc that will be displayed, is to create a fake UTC time that mimics local time.
 * The days, hours, etc are then extracted with the JS functions Date.getUTCDate, Date.getUTCHours, etc.
 * This is achieved with the following lines of code in src/format/index.js:
 *
