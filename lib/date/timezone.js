...
/**
 * Given a tzid, return true if it's a deprecated timezone (i.e. it's a key in the deprecatedTimezoneLinks object above)
 */
export const isDeprecated = (tzid) => {
    return Object.keys(deprecatedTimezoneLinks).includes(tzid);
};
...
export const getTimezone = () => {
    ...
    if (isDeprecated(timezone)) {
        return deprecatedTimezoneLinks[timezone];
    }
    if (!timezone) {
