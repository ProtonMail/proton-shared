...
import { templates as sieveTemplates } from './sieve';
...
export const getI18n = () => ({
    TYPES: [
        ...
        { label: c('Filter modal type').t('the subject'), value: 'subject' },
        { label: c('Filter modal type').t('the sender'), value: 'sender' },
        { label: c('Filter modal type').t('the recipient'), value: 'recipient' },
        { label: c('Filter modal type').t('the attachments'), value: 'attachments' }
    ],
    COMPARATORS: [
    ...
    OPERATORS: [
        { label: c('Filter modal operators').t('AND'), value: 'all' },
        { label: c('Filter modal operators').t('OR'), value: 'any' }
    ]
});
