...
import { PACKAGE_TYPE, RECIPIENT_TYPE, MIME_TYPES, KEY_FLAGS } from 'lib/constants';
import { Key, Address } from 'lib/interfaces';

import { Message } from '../../../proton-mail/src/app/models/message';
import { isEO, isSign } from '../../../proton-mail/src/app/helpers/message/messages';
import { normalizeEmail } from '../../../proton-mail/src/app/helpers/addresses';
import { getByEmail, isOwnAddress, isFallbackAddress } from '../../../proton-mail/src/app/helpers/addresses';
import { KeyData } from 'lib/interfaces';
import { findEmailInCache } from '../../../proton-mail/src/app/helpers/contacts';
import { ContactEmailCache, ContactEmail } from 'lib/interfaces/contacts/Contact';
import { base64ToArray } from '../../../proton-mail/src/app/helpers/base64';

export type MapPreference = { [email: string]: SendPreferences };
