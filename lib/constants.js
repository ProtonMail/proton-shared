...
export const DARK_THEME_LABEL = 'Dark (Default)';
export const DARK_THEME_VALUE = 'dark-theme';
export const LIGHT_THEME_LABEL = 'Light';
export const LIGHT_THEME_VALUE = 'light-theme';
export const LIGHT_THEME_IDENTIFIER = '/* light-theme */';
export const BLUE_THEME_LABEL = 'Blue';
export const BLUE_THEME_VALUE = 'blue-theme';
export const BLUE_THEME_IDENTIFIER = '/* blue-theme */';
export const CUSTOM_THEME_LABEL = 'Custom theme';
export const CUSTOM_THEME_VALUE = 'custom-theme';
